...
def main():
    ...
    gs.tools.run_in_another_thread(fn=run_sim_single_pos, args=(scene, robot, dofs_idx, joint_names, B, args.vis))
    if args.vis:
        scene.viewer.start()
...
def run_sim_single_pos(scene, robot, dofs_idx, joint_names, B, enable_vis):
